...
if __name__ == "__main__":
    ...
    # yolov3-tiny
    file_cfg = b"/content/drive/MyDrive/GOOGLE_COLAB/Trafic_Sign/yolov4.cfg"
    file_weights = b"/content/drive/MyDrive/GOOGLE_COLAB/Trafic_Sign/backup/yolov4_best.weights"
    file_data = b"/content/drive/MyDrive/GOOGLE_COLAB/Trafic_Sign/obj.data"
